...
class Loading extends Component{
  ...
  componentDidMount(){
    // TODO: Some people say refs are bad so investigate if they are bad, why, and how to replace them
    if(this.refs.widget){
      TweenMax.to(this.refs.widget, 5, {rotation: 360, fill: 'rgb(52, 152, 219)', ease: Power0.easeNone, repeat: -1, yoyo: true})
    }
  }
  ...
  render() {
    return (
      <div className="loading">
        <svg className="svg" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" ref="widget">
          <path className="widget" d="M88.553,43.441l-10.276-1.013c-0.661-2.466-1.644-4.832-2.936-7.059l6.561-7.993c0.703-0.859,0.639-2.111-0.145-2.893
